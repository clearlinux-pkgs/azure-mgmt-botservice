...
License  : MIT
Requires: azure-mgmt-botservice-python = %{version}-%{release}
Requires: azure-mgmt-botservice-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-botservice package.
Group: Default
Requires: azure-mgmt-botservice-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-botservice package.


%package python3
Summary: python3 components for the azure-mgmt-botservice package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_botservice)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-botservice package.


%prep
%setup -q -n azure-mgmt-botservice-0.2.0
cd %{_builddir}/azure-mgmt-botservice-0.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588701348
